  ...
  return (
    <div className="bg-slate-100 dark:bg-slate-900 py-6 pt-20">
      ...
      <div className="flex justify-center items-center">
        {memberData.map((data, i) => (
          <MemberCard key={i} data={data} idx={i} theme={theme} />
        ))}
      </div>
    </div>
  );
...
const MemberCard = ({ data, idx, theme }) => {
  //console.log(theme)
  return (
    <div className="p-8 text-center">
      <div className=" relative rounded-3xl">
        <div
          className="flex max-w-[400px] mx-auto justify-center items-center rounded-full mb-4 p-4 animation-rotate-forward "
          style={{
            border: `2px dashed ${theme === "light" ? "#000000" : "#ffffff"}`, // using actual hex color codes
            boxShadow: "0 10px 30px #101e360f",
          }}
        >
          <img
            draggable={false}
