...
const LeadForm = () => {
  ...
  return (
    <div className="pt-[100px] md:pt-[200px] md:pb-[80px] md:p-20 p-5 bg-slate-100 dark:bg-gray-900">
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-8 max-w-6xl mx-auto">
        ...
        <div className="p-10 bg-white dark:bg-slate-800 dark:text-gray-100 rounded-3xl">
          ...
          <form
            ...
            className="flex flex-col gap-6 floating-input-form"
          >
            ...
            <input
              type="submit"
              value="Submit"
              className={`px-5 cursor-pointer py-3 ${
                theme === "light"
                  ? "bg-black text-white"
                  : " bg-white text-black"
              }   w-fit  rounded-xl`}
