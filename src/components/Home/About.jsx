...
const data = {
  ...
  desc: "At Cryptic, we believe a founder’s story is their most powerful growth engine. In today’s world, people don’t just follow companies — they follow leaders. Your personal brand is what builds trust, attracts opportunities, and turns your vision into influence.",
  desc2:
    "Apart from bringing the tech story we also work with new-age tech brands along with D2C companies to bring the best versions of their stories.",
  image: "/about/about3.jpeg",
};
      ...
      <div className="md:py-[100px] md:px-20 px-5 py-5 bg-slate-200 dark:bg-gray-800">
        ...
        <div className="flex justify-center items-center flex-col md:flex-row gap-5 ">
          ...
          <div className="w-full">
            ...
            <h3 className="md:text-xl text-lg text-slate-900 dark:text-slate-100 font-thin mb-5">
              {data.desc}
            </h3>
