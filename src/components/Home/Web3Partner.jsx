    ...
    return (
        <div className='md:py-[150px] md:px-20 px-5 py-20 bg-slate-100 dark:bg-gray-900'>
            ...
            <div className='flex justify-center items-center gap-2 mb-8'>
                <AnimatedTitle title={'Our'} classes={'font-semibold text-gray-900 dark:text-white text-4xl text-center'} />
                <AnimatedTitle title={'Customers'} classes={'font-semibold text-rose-500 dark:text-rose-500 text-4xl text-center'} />
            </div>
