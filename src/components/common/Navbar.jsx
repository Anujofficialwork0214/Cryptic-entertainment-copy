      ...
      <ul className="flex flex-row self-end h-12">
        {navigationData.map((item, index) => (
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "w-20 text-black dark:text-white border-b-4 border-black dark:border-white bg-gradient-to-b from-white/0 dark:from-black/0  to-white-500/20 dark:to-white-500/20 flex items-start justify-center "
