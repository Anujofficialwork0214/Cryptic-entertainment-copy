...
export default function PrivacyPolicy() {
    return (
        ...
        >
            <Banner title1="Privacy" title2="Policy" />
            <div className="max-w-[1200px] mx-auto px-4 py-8 lg:py-10 text-black dark:text-white policy-page">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Cryptic Entertainment, Industrial Area
                            Phase 2, Chandigarh.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <strong>Country</strong> refers to: Chandigarh,
                            India
                        </p>
                    </li>
                    <li>
